...
| ---------------- | ---------------------- | --------------------------- |
| Page background  | `--bg-base`            | `#111111`                   |
| Surface          | `--bg-surface`         | `#191919`                   |
| Elevated surface | `--bg-elevated`        | `#222222`                   |
| Subtle surface   | `--bg-subtle`          | `#2a2a2a`                   |
| Default border   | `--border-default`     | `#201e18`                   |
