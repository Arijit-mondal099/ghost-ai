  ...
  items={(defaultItems) =>
    defaultItems.map((item) => {
      ...
      if (item.name === "Heading 1") {
        label = <span style={{ fontSize: 18, fontWeight: "bold" }}>Heading 1</span>;
      }

      if (item.name === "Heading 2") {
        label = <span style={{ fontSize: 16, fontWeight: "bold" }}>Heading 2</span>;
      }

      if (item.name === "Heading 3") {
        label = <span style={{ fontSize: 15, fontWeight: "bold" }}>Heading 3</span>;
      }

      if (item.name === "Blockquote") {
        label = <span style={{ borderLeft: "3px solid gray", paddingLeft: 8 }}>Blockquote</span>;
      }
